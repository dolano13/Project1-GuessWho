...
function getRandom() {
  for (i = 0; i < 24; i++) {
    ...
    $("#gameboard div")
      .eq(i)
      .html(`<img src="${character.image}" name="${character.name}" />`);
  }
}
